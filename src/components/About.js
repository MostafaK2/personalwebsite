    ...
    <section id="about" ref={aboutRef}>
      <div className="max-w-screen-md increase-width mt-24 w-2/3 mx-auto flex flex-col justify-center items-center gap-7">
        <div className="flex flex-col gap-7">
          ...
          <p className="text-lg">
            I'm not just a software developer but rather I'm a storyteller, a
            problem-solver, and an eternal learner. My journey in computer
            science has been a captivating adventure filled with challenges and
            triumphs. Each experience has sculpted me into the professional I am
            today.
          </p>
